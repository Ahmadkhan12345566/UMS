...
<div class="kt-grid kt-grid--hor kt-grid--root">
            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                    <ul class="kt-menu__nav ">
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>instructions" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-exclamation"></i><span class="kt-menu__link-text">Instructions</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>personalinformation" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-user-graduate"></i><span class="kt-menu__link-text">Personal Information</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>addressdetail" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-placeholder-2"></i><span class="kt-menu__link-text">Address Details</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>photoupload" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-image-file"></i><span class="kt-menu__link-text">Photo Upload</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>educationdetails" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-graduation-cap"></i><span class="kt-menu__link-text">Education Details</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>ntsdetails" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-sheet"></i><span class="kt-menu__link-text">NTS Details</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>programchoices" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-tasks"></i><span class="kt-menu__link-text">Program Choices</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>workhistory" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-history"></i><span class="kt-menu__link-text">Work History</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>funddetails" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-wallet"></i><span class="kt-menu__link-text">Fund Details</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>publicationdetails" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-file-powerpoint"></i><span class="kt-menu__link-text">Publication Details</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>researchinterests" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-pen-alt"></i><span class="kt-menu__link-text">Research Interest</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>documentsupload" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-doc"></i><span class="kt-menu__link-text">Documents Upload</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>otherdetail" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-list-1"></i><span class="kt-menu__link-text">Other Details</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>confirmfee" class="kt-menu__link "><i class="kt-menu__link-icon la la-check-circle"></i><span class="kt-menu__link-text">Confirm Fee</span></a></li>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url()?>submitapplication" class="kt-menu__link "><i class="kt-menu__link-icon la la-mail-forward"></i><span class="kt-menu__link-text">Submit Application</span></a></li>
                    </ul>
                </div>
            </div>
    ...
    -->
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
									<span class="kt-header__topbar-icon">
										<img class="" src="./assets/media/flags/pakistan.svg" alt="" />
									</span>
                        </div>
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                            <div class="kt-header__topbar-user">
                                ...
                                <span class="kt-header__topbar-username kt-hidden-mobile">Mussawar Ahmad</span>
                                <img class="kt-hidden" alt="Pic" src="./assets/media/users/300_25.jpg" />

                                <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                                <span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold">MA</span>
                            </div>
                        </div>
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
