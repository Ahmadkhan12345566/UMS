...
<!--begin::Page Vendors(used for calender) -->
...
<!--begin::Page Scripts(used for dashboard) -->
<script src="./assets/js/demo1/pages/dashboard.js" type="text/javascript"></script>

<!--end::Page Scripts -->

<!--begin::Page Scripts(Use for datepicker) -->
<script src="./assets/js/demo1/pages/crud/forms/widgets/bootstrap-datepicker.js" type="text/javascript"></script>

<!--end::Page Scripts -->

<!--begin::Page Scripts(used for add information in one page with multiple wizard) -->
<script src="./assets/js/demo1/pages/custom/user/add-user.js" type="text/javascript"></script>

<!--end::Page Scripts -->

<!--begin::Page Scripts(used for file upload) -->
