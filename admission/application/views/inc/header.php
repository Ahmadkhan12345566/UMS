...
<head>
    ...
    <base href="../../../UMS/admission/application/">
    ...
    <!--begin::Page Vendors Styles(used for calender) -->
    <link href="./assets/vendors/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />

    <!--end::Page Vendors Styles -->

    <!--begin::Page Custom Styles(used for wizard) -->
    <link href="./assets/css/demo1/pages/wizard/wizard-4.css" rel="stylesheet" type="text/css" />

    <!--end::Page Custom Styles -->

    <!--begin::Page Custom Styles(used for login) -->
