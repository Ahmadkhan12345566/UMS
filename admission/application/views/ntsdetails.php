            ...
            <div class="row">
                <div class="col-lg-12 col-xl-8">
                    ...
                    <div class="kt-portlet">
                        ...
                        <!--begin::Form-->
                        <form class="kt-form" method="post" action="<?php echo base_url("ntsdetails")?>">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ntsrollnumber">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="obtainedmarks">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                <input type="text" class="form-control" name="testdate" placeholder="Test Date" readonly="" id="kt_datepicker_2">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ntscenter">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Roll Number</label>
                                            <input type="text" class="form-control" name="allntsrollnumber">
                                        </div>
                                    </div>
                                </div>
                            </div>
