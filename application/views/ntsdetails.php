                        ...
                        <div class="card-body">
                            <form>
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12  pr-1">
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">NTS Test Registration Through COMSATS University</legend>
                                            ...
                                            <div class="form-group">
                                                ...
                                                Yes <input type="radio" name="yesnts" id="yesnts">
                                                No <input type="radio" name="nonts" id="nonts" checked>
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 pr-1">
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">NTS Test already taken?</legend>
                                            <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="ntsrollnumber" aria-describedby="ntsrollnumberHelp" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="obtainedmarks" aria-describedby="obtainedmarksHelp" placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 pr-1">
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">If already registered in a NTS Test Centre?</legend>
                                            <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="ntscenter" aria-describedby="ntscenterHelp" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
